...
PRODUCT_COPY_FILES += \
    vendor/htc/protou/proprietary/bin/htc_ebdlogd:system/bin/htc_ebdlogd \ # missing
    vendor/htc/protou/proprietary/bin/mm-jpeg-dec-test:system/bin/mm-jpeg-dec-test \ # missing
    ...
    vendor/htc/protou/proprietary/bin/mm-jpeg-enc-test:system/bin/mm-jpeg-enc-test \ # missing
    ...
    vendor/htc/protou/proprietary/bin/mm-qcamera-test:system/bin/mm-qcamera-test \ # missing
    vendor/htc/protou/proprietary/bin/htcfs:system/bin/htcfs \
    vendor/htc/protou/proprietary/bin/mm-qcamera-testsuite-client:system/bin/mm-qcamera-testsuite-client \ # missing
    ...
    vendor/htc/protou/proprietary/bin/test_gemini:system/bin/test_gemini \ # missing
    vendor/htc/protou/proprietary/bin/RescueServer:system/bin/RescueServer \
    vendor/htc/protou/proprietary/bin/mm-jpeg-enc-test-client:system/bin/mm-jpeg-enc-test-client \ # missing
    vendor/htc/protou/proprietary/lib/libmmjpeg.so:system/lib/libmmjpeg.so \
    vendor/htc/protou/proprietary/lib/libOmxMpeg4Dec.so:system/lib/libOmxMpeg4Dec.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/libC2D2.so:system/lib/libC2D2.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/libwvdrm_L3.so:system/lib/libwvdrm_L3.so \ # missing
    vendor/htc/protou/proprietary/lib/libOpenVG.so:system/lib/libOpenVG.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/libDxOAF.so:system/lib/libDxOAF.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/egl/libGLESv2S3D_adreno200.so:system/lib/egl/libGLESv2S3D_adreno200.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/libmmparser.so:system/lib/libmmparser.so \ # missing
    vendor/htc/protou/proprietary/lib/libWVStreamControlAPI_L3.so:system/lib/libWVStreamControlAPI_L3.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/libmmparser_divxdrmlib.so:system/lib/libmmparser_divxdrmlib.so \ # missing
    vendor/htc/protou/proprietary/lib/libOlaEngine.so:system/lib/libOlaEngine.so \ # missing
    vendor/htc/protou/proprietary/lib/libWVphoneAPI.so:system/lib/libWVphoneAPI.so \
    vendor/htc/protou/proprietary/lib/libwvm.so:system/lib/libwvm.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/hw/sensors.default.so:system/lib/hw/sensors.default.so \ # missing
    vendor/htc/protou/proprietary/lib/hw/camera.default.so:system/lib/hw/camera.default.so \ # missing
    vendor/htc/protou/proprietary/lib/libmmcamera_statsproc31.so:system/lib/libmmcamera_statsproc31.so \
    vendor/htc/protou/proprietary/lib/libc2d2_z180.so:system/lib/libc2d2_z180.so \ # missing
    ...
    vendor/htc/protou/proprietary/lib/libmmosal.so:system/lib/libmmosal.so \ # missing
